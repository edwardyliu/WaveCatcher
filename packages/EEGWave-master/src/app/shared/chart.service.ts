    ...
    return [
      {
        ...
        backgroundColor: 'rgba(112,185,252,1)',
      },
      {
        borderColor: 'rgba(116,150,161,1)',
        backgroundColor: 'rgba(116,150,161,1)',
      },
      {
        borderColor: 'rgba(162,86,178,1)',
        backgroundColor: 'rgba(162,86,178,1)',
      },
      {
        borderColor: 'rgba(144,132,246,1)',
        backgroundColor: 'rgba(144,132,246,1)',
      },
      {
        borderColor: 'rgba(138,219,229,1)',
        backgroundColor: 'rgba(138,219,229,1)',
      },
      {
        borderColor: 'rgba(207,181,59, 1)',
        backgroundColor: 'rgba(207,181,59, 1)',
      },
      {
